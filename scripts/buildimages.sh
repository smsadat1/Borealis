...
docker build -t borealis-exec-js-node-14 -f ../docker/languages/Dockerfile.js.node.14 .
docker build -t borealis-exec-js-node-18 -f ../docker/languages/Dockerfile.js.node.18 .
docker build -t borealis-exec-js-node-20 -f ../docker/languages/Dockerfile.js.node.20 .